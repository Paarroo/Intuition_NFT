    ...
    <div className="sticky lg:static top-0 navbar min-h-0 shrink-0 justify-between z-20 px-0 sm:px-2">
      <div className="navbar-start w-auto lg:w-1/2">
        <details className="dropdown" ref={burgerMenuRef}>
          ...
          <ul
            className="menu menu-compact dropdown-content mt-3 p-2 glassmorphism-dropdown rounded-box w-52"
            onClick={() => {
              burgerMenuRef?.current?.removeAttribute("open");
            }}
          >
        ...
        <Link href="/" passHref className="hidden lg:flex items-center gap-3 ml-4 mr-6 shrink-0">
          ...
          <div className="flex flex-col">
            <span className="font-bold leading-tight text-base">SRE Challenges</span>
            <span className="text-sm">Simple NFT Example</span>
          </div>
        </Link>
